    ...
    <div style="height: 81px">
        ...
        <div style="display: block;float: right;;text-align: right;top: 2px;margin-top: 16px;margin-right: 5px;position: relative">
            ...
            <div style="text-align: right;margin-top: 12px;">
                <span style="font-size: 1.1rem;font-weight: 500;">ใบสั่งจองสินค้า - Reserve Order</span>
                <div style="position: absolute;right: 0" class="underline"></div>
            </div>
    ...
    <div style="width: 100%;height: 170px;margin-top: -5px;">
                ...
                <div class="settop" style="width: 95%;height: 69%">
                    <div style="width: 100%;height: 65%">
                        ...
                        <div style="width: 70%; padding-left: 13px; word-break: break-word; float: right; line-height: 16px;">
                            <span style="font-size: 0.68rem;font-weight: bold;padding-left: 15px;">
            ...
            <div style="float: right;width: 33%;height: 100%;border: 1px solid black;border-radius: 8px;position:relative">
                ...
                <div class="settop">
                    <div style="height:14%;padding-right: 5px;text-align: right">
                        <span style="font-size: 0.88rem">เลขที่ใบสั่งจอง</span>
                    </div>
        ...
        <div id="heightproduct" style="width: 100%;border-top: 1px solid black;border-left: 1px solid black;height: 336.77px;border-right: 1px solid black;border-radius: 5px">
            <div style="width: 100%;    height: 25px;border-bottom: 1px solid black">
                ...
                <div style="float:left;width: 39.5%;height: 100%;border-right: 1px dashed grey;position: relative">
                ...
                <div style="float: left;width: 6.5%;height: 100%;border-right: 1px dashed grey;position: relative">
                    <span style="font-size: 0.48rem; position: absolute; bottom: 3px; white-space: nowrap;">QTYออกบิล(จอง)</span>
                </div>
                <div style="float: left;width: 6.5%;height: 100%;position: relative;border-right: 1px dashed grey;">
                    <span style="font-size: 0.48rem; position: absolute; bottom: 3px; white-space: nowrap;">QTY  ออกบิล(ที่ค้างส่ง)</span>
                </div>
                <div style="float: left;width: 6.5%;height: 100%;position: relative;border-right: 1px dashed grey;">
                    <span style="font-size: 0.68rem;position: absolute;bottom: 3px;right: 5px">หน่วยนับ</span>
                </div>
                <div style="float: left;width: 6.5%;height: 100%;position: relative;border-right: 1px dashed grey;">
                    <span style="font-size: 0.58rem;white-space: nowrap;position: absolute;bottom: 3px;">ราคาต่อหน่วย</span>
                </div>
                <div style="float: left;width: 6.5%;height: 100%;position: relative;border-right: 1px dashed grey;">
            ...
            <div id="counttable" style="width: 100%;height: calc(100% - 25px);border-bottom: 1px solid black;position: relative">
                ...
                <div style="left: 8%;width: 39.5%;height: 100%;border-right: 1px dashed grey;position: absolute">

                </div>
                <div style="left: 47.5%;width: 6.5%;height: 100%;border-right: 1px dashed grey;position: absolute">

                </div>
                <div style="left:54%;width: 6.5%;height: 100%;border-right: 1px dashed grey;position: absolute">
...
<!--                   20% -->
                    <div style="width: 39.5%;float:left;position: relative;line-height: 20px;padding-left: 5px">
                     <span style="font-size: 0.68rem;">
...
-->
        ...
        <div style="height: 170px;border: 1px solid black;border-radius: 5px">
            ...
            <div style="float:left;position: relative;padding-top: 5px;padding-left: 5px;width:63.5%;height: 60%;">
                <div style="position: absolute; bottom: -70px; left: 0; width: 57.5%; height: 105%; border-top: 1px solid black;">
                    <p>หมายเหตุท้ายใบจอง :</p>
                    <p>1. สินค้าสั่งพิเศษ งดรับ/เปลี่ยนคืน และไม่คืนเงินมัดจำ กรณียกเลิกสั่ง</p>
                    <p>2. สินค้าข้างต้นเป็นกรรมสิทธิ์ของผู้ขายจนกว่าจะได้รับการชำระเงินครบถ้วน</p>
                    <p>3. บริษัทสงวนสิทธิ์รับฝากสินค้าไม่เกิน 15 วันนับจากวันที่นัดรับ</p>
                    <p>4. สินค้าสั่งพิเศษ ลูกค้าไม่รับตามกำหนดเกิน 30 วัน</p>
                    <p style="padding-left:14px;">   จะคิดค่าบริการคลัง 1% ของมูลค่าสินค้า</p>
                </div>
                
                
                <div style="position: absolute;right: -2px;bottom:0;border-top: 1px solid black;height: 34%;width: 42.8%;border-left: 1px solid;">
                    <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);white-space:nowrap;font-size:0.9rem">*S* = Special Order</div>
                </div>
                <span style="font-size: 0.85rem;font-weight: bold;white-space: nowrap;line-height: 1.5"><span style="font-weight: 100">หมายเหตุ : </span></span>
                <span style="font-size: 0.85rem;font-weight: bold;white-space: nowrap;line-height: 1.5;padding-left: 50px;"></span>
                <!--
            ...
            <div style="display:block">
                <div style="float: right;height: 42.5%;position: relative;border-left: 1px dashed grey;border-top: 1px solid black;">
                    ...
                    <div style="width:120px;height: 100%;text-align: center;border-right: 1px dashed grey;float: left;position:relative">
                        <span style="position: relative;top: 10px">ผู้สั่งจอง</span>
                    ...
                    <div style="width: 109px;height: 100%;text-align: center;border-right: 1px dashed grey;float: left">
                        ...
                        <span style="position: relative;top: 10px">ผู้อนุมัติการจอง</span>
                    </div>
