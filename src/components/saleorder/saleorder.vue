    ...
    <div ref="testDiv" class="fluid-container">
      <div>
        <div class="container-fluid">
          ...
          <md-steppers md-sync-route md-dynamic-height :md-active-step.sync="active" md-linear>
            <md-step
              id="first"
              md-label="First Step"
              ...
              <md-card-content>
                ...
                <div class="md-layout md-gutter">
                  ...
                  <div
                    ...
                    style="text-align:right;"
                  >
                    <span class="md-title subnotop">0.00</span>
                  </div>
                  <div
                    class="md-layout-item md-size-10 md-xsmall-size-100"
                    style="text-align:center;"
                  ...
                  <transition name="fade">
                    ...
                    >
                      ...
                      <md-card-content>
                        ...
                        <div class="md-layout md-gutter">
                          <div
                            class="md-layout-item md-xlarge-size-50 md-large-size-50 md-xsmall-size-50 md-small-size-50 md-medium-size-50"
                          >
                            <md-field>
            ...
            <md-step id="third" md-label="Third Step" :md-done.sync="third">
              <div class="md-layout md-gutter">
                ...
                >
                  <span>This invoice is brought to you by</span>
                ...
                <table class="table table-hover">
                  ...
                  <tbody v-for="(val,index) in dataproductDialog" id="valuetable">
                    <tr @click="findstock(val,index)" style="text-align:center;cursor:pointer">
                      ...
                      <td>
                        <div style="height:18px;">{{ val.stk_qty }}</div>
                      </td>
                      <td>
                        <div style="height:18px;">{{ val.rate_1 }}</div>
                      </td>
                    </tr>
                    <tr class="nohover">
                      <td style="display:none;" :class="'trshow'+index" colspan="10">
                        ...
                        <div
                          class="hovercolor"
                          :class="'hover'+index"
                          style="text-align:right;visibility:hidden;height:0;transition:all 0.5s cubic-bezier(0.47, 0.46, 0, 1.02) 0s;"
                          v-for="(value,index2) in stockall"
                          :key="index2"
                        >
                          <!--  -->
                          <md-button
                            @click="showdetail(val,value,index2)"
                            style="margin: 5px 0"
                            class="md-raised md-primary"
                          >คลังสินค้า : {{val.stk_location[index2].wh_code}} ชั้นเก็บ : {{val.stk_location[index2].shelf_code}} จำนวน : {{val.stk_location[index2].qty}}</md-button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
